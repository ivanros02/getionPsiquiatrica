...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 08-10-2024 a las 17:54:49
...
INSERT INTO `nutricion` (`id`, `id_paciente`, `patologias`, `indicacion_dieta`, `actitud_comida`, `peso`, `talla`, `imc`, `requiere`, `no_requiere`, `especificar`) VALUES
(4, 150, 'HTA', 'NADA', 'NADA', '10', '10', '100', 'NADA', 'NADA', 'NADA');
