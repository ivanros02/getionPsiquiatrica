...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE origen_ingreso SET codigo = ?, descripcion = ? WHERE id = ?";
    ...
    if ($stmt->execute()) {
        ...
        header("Location: ./origen.php?success=true");
        exit();
    } else {
        // Manejar el error
        echo "Error al actualizar el origen de ingreso: " . $conn->error;
    }
