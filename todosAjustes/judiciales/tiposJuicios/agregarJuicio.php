...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO t_juicio (codigo, descripcion) VALUES (?, ?)";
    ...
    if ($stmt->execute()) {
        ...
        echo "<script>alert('Tipo de juicio agregada correctamente.'); window.location.href = './tiposJuicios.php';</script>";
    } else {
        // Si hubo un error al agregar la especialidad, mostrar una alerta con el mensaje de error
        echo "<script>alert('Error al agregar juicio: " . $stmt->error . "');</script>";
    }
