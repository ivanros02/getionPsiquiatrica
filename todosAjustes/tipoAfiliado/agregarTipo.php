...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO tipo_afiliado (codigo, descripcion) VALUES (?, ?)";
    ...
    if ($stmt->execute()) {
        ...
        echo "<script>alert('Tipo agregado correctamente.'); window.location.href = './tipoAfiliado.php';</script>";
    } else {
        // Si hubo un error al agregar la especialidad, mostrar una alerta con el mensaje de error
        echo "<script>alert('Error agregar tipo: " . $stmt->error . "');</script>";
    }
