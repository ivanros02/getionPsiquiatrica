...
if (isset($_GET['id'])) {
    ...
    if ($result->num_rows > 0) {
        ...
        echo "<script>editarCategoria(" . json_encode($row) . ");</script>";
    }
    $stmt->close();
}
    ...
    <div class="container">
        <div class="title-container">
            ...
            <button type="button" class="btn btn-custom btn-lg" data-bs-toggle="modal"
                ...
                Agregar Categorias <img src="../../img/categorias.png" alt="Icono agregar Categorias"
                ...
                <?php if ($result->num_rows > 0): ?>
                    <?php while ($row = $result->fetch_assoc()): ?>
                        <tr>  
                            ...
                            <td>
                                <button class="btn btn-custom-editar" onclick='editarCategoria(<?= json_encode($row) ?>)'><i
                                        class="fas fa-pencil-alt"></i></button>


                                <a href="?eliminar=<?= $row['id'] ?>" class="btn btn-danger"
                                    onclick="return confirm('¿Estás seguro de que deseas eliminar esta categoria?');"><i
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="formCategoria" action="./agregarCategoria.php" method="POST">
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            function editarCategoria(categoria) {
                document.getElementById('formCategoria').action = './editarCategoria.php'; // Asegúrate de que el formulario apunta a la URL correcta
                ...
                var modal = new bootstrap.Modal(document.getElementById('agregarCategoriaModal'));
                modal.show();
            }

            // Función para limpiar el formulario
            function limpiarFormulario() {
                document.getElementById('formCategoria').action = './agregarCategoria.php';
            ...
            var btnAgregarCategoriaModal= document.querySelector('button[data-bs-target="#agregarCategoriaModal"]');
            btnAgregarCategoriaModal.addEventListener('click', limpiarFormulario);
