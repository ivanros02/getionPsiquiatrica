...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO diag (codigo, descripcion) VALUES (?, ?)";
    ...
    if ($stmt->execute()) {
        ...
        echo "<script>alert('Diagnostico agregado correctamente.'); window.location.href = './diag.php';</script>";
    } else {
        // Si hubo un error al agregar la especialidad, mostrar una alerta con el mensaje de error
        echo "<script>alert('Error al agregar diagnostico: " . $stmt->error . "');</script>";
    }
